...
func (c *metricsServiceClient) StreamMetrics(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[MetricPayload, Ack], error) {
...
type MetricsService_StreamMetricsClient = grpc.ClientStreamingClient[MetricPayload, Ack]
...
func (UnimplementedMetricsServiceServer) StreamMetrics(grpc.ClientStreamingServer[MetricPayload, Ack]) error {
...
func _MetricsService_StreamMetrics_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(MetricsServiceServer).StreamMetrics(&grpc.GenericServerStream[MetricPayload, Ack]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MetricsService_StreamMetricsServer = grpc.ClientStreamingServer[MetricPayload, Ack]
